      ...
      <form class="needs-validation" novalidate >
        <div class="row g-3">
          ...
          <div class="col-md-12">
            ...
            <input id="gwas1_input2" class="form-control" v-model="selected2" placeholder="QTL">
            <span v-if="checkinputback" class="invalid-feedback" style="display:block;">QTL location information不能为空</span>
          </div>
        </div>
        <hr class="my-4">
